...
> **序号**：09 · **类型**：todo · **创建**：2026-07-07 · **最后更新**：2026-07-12 · **状态**：🔄 进行中（P1 T10/T11/T12/T13 已落地；下一步互动赞评藏 / 书币充值）  
...
| 优先级 | 行动 |
|:---:|---|
| **现在** | 互动（赞评藏）· 接口与详情页接入（11-track 实现优先级 P2） |
| **接着** | 书币充值（资质就绪后启用 `recharge_enabled`） |
...
**阶段定位**：P1 首页信息流、话题广场、登录/设置、二级页面（热榜/精选/话题详情/发起话题/搜索）已落地；下一步推进互动（赞评藏）与书币充值。
...
| 11 | [`18-track-T12二级页面实施方案-2026-07-12.md`](18-track-T12二级页面实施方案-2026-07-12.md) | T12 热榜/精选/话题详情/发起话题/搜索 |
...
| T10 | 首页/话题完整页实施 | [x] |
| T11 | C 端多方式登录（阶段二） | [x] |
| T13 | 账号体系 V13（internal_uid / account_name）+ 设置页 | [x] |

### 产品阶段二 — 明确不做（见 10-track §7）
...
| ID | 任务 | 状态 |
|:---:|---|:---:|
| T12 | 热榜完整页 / 精选新文列表页 / 话题详情页 / 发起话题页 / 搜索结果页 | [x]（见 [`18-track`](18-track-T12二级页面实施方案-2026-07-12.md)） |

---

## 五、建议下一步（本周）

1. **互动（赞评藏）**：接口与详情页接入（11-track 实现优先级 P2）
2. **书币充值**：资质就绪后启用 `recharge_enabled`
3. **真机冒烟 T12**：封面上传、发起话题扣币、搜索四类型（见 18-track 第五节）
...
| 2026-07-12 | 澄清用语：P1 后续 T12 / 产品阶段二（明确不做）/ 11-track 实现优先级（互动赞评藏）；补 T12 路由占位说明与建议下一步精选列表；P1 表补 T13 |
| 2026-07-12 | T12 完成：本地上传代替 OSS、搜索四类型、话题文章列表、热榜/精选/话题详情/发起话题/搜索小程序页；见 `18-track` |
