...
public class Tag extends TableImpl<TagRecord> {
    ...
    /**
     * The reference instance of <code>ice.tag</code>
     */
    ...
    /**
     * The column <code>ice.tag.id</code>.
     */
    public final TableField<TagRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>ice.tag.name</code>.
     */
    public final TableField<TagRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>ice.tag.use_count</code>.
     */
    public final TableField<TagRecord, Integer> USE_COUNT = createField(DSL.name("use_count"), SQLDataType.INTEGER.nullable(false).defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "");
    ...
    /**
     * Create an aliased <code>ice.tag</code> table reference
     */
    ...
    /**
     * Create a <code>ice.tag</code> table reference
     */
    public Tag() {
    ...
    public List<UniqueKey<TagRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_TAG_UK_TAG_NAME);
    }
