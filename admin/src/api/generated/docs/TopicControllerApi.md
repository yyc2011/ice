...
|------------- | ------------- | -------------|
| [**articles**](TopicControllerApi.md#articles) | **GET** /api/v1/topics/{id}/articles |  |
...
> TopicArticlesResponse articles(id, sort, page, size)
...
import type { ArticlesRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // number (optional)
    size: 56,
  } satisfies ArticlesRequest;

  try {
    const data = await api.articles(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **sort** | `string` |  | [Optional] [Defaults to `&#39;hot&#39;`] |
| **page** | `number` |  | [Optional] [Defaults to `1`] |
| **size** | `number` |  | [Optional] [Defaults to `20`] |

### Return type

[**TopicArticlesResponse**](TopicArticlesResponse.md)
